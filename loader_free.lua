-- loader_free.lua (с альтернативой bit32.bxor)
...
local encryptedCode = game:HttpGet("https://github.com/MwHvh/MI-Cheat-Free/raw/refs/heads/main/encrypted_aimbot_free.lua")
local key = 42
